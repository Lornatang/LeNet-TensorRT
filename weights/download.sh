...
echo "Create TensorRT models directory ..."
sudo mkdir -p /opt/tensorrt_models/torch/lenet/
echo "Downloading LeNet(PyTorch) weights ..."
wget -P /opt/tensorrt_models/torch/lenet/ https://github.com/Lornatang/LeNet-TensorRT/releases/download/v0.1/lenet.pth
