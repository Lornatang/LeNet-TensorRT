...
// Source code from https://github.com/NVIDIA/TensorRT/blob/master/samples/common/argsParser.h

#ifndef LENET_ARGS_PARSER_H
#define LENET_ARGS_PARSER_H
