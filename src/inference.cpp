...
void inference(IExecutionContext &context, float *input, float *output,
               const char *input_name, const char *ouput_name, int batch_size,
               unsigned int channel, unsigned int image_height,
